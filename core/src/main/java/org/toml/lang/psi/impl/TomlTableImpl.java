...
public class TomlTableImpl extends CompositePsiElement implements TomlTable {
    public TomlTableImpl(IElementType type) {
        super(type);
    }
    ...
    public TomlTableHeader getHeader() {
        ...
        if (header == null) {
            throw new IllegalStateException("Invalid TOML PSI: Expected to find TomlTableHeader child of TomlTable\nElement text:\n" + getText());
        }
        return header;
    }
    ...
    public void accept(@Nonnull PsiElementVisitor visitor) {
        if (visitor instanceof TomlVisitor) {
            ((TomlVisitor) visitor).visitTable(this);
        } else {
